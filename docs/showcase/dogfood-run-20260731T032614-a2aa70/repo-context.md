...
- **assembled_at:** 2026-07-30T21:56:14Z

## git status

```
M src/devmemory/DEV.md
?? docs/showcase/dogfood-run-20260731T032535-73934d/
```

## recent log

```
715a38c R7: devmemory validate for CI knowledge form (no transcripts)
4ec0d6f R6 dogfood: gate offline fallback, scrub thrash, Opus showcase
...
- [src/devmemory/DEV.md#Design decisions] apply assemble extract extraction normalize pipeline
- [src/devmemory/DEV.md#Design decisions] dependency includ source vendor
- [src/devmemory/DEV.md#Design decisions] extraction openrouter provider
- [src/devmemory/DEV.md#Design decisions] develop entirely extraction knowledge locally machine never operat
- [src/devmemory/DEV.md#Design decisions] accessible colocat context-specific devmd document easily knowledge maintain
- [src/devmemory/DEV.md#Design decisions] artifact avoid committ c
